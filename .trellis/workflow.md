...
Based on your task, read the **detailed** guidelines in `.trellis/spec/guides/`.
...
```bash
# Read guides index first, then specific docs based on task
cat .trellis/spec/guides/index.md
```
...
- See `.trellis/spec/guides/` for project guidelines
...
|-----------|-------------------|
| Any work | `guides/index.md` → relevant docs |
