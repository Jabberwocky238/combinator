...
func NewSeaweedFSS3(parsed *ParsedS3URL) (*SeaweedFSS3, error) {
...
func (s *SeaweedFSS3) Start() error {
...
func (s *SeaweedFSS3) Close() error {
	return nil
}

func (s *SeaweedFSS3) Type() string {
	return "seaweedfs"
}

// Head 获取对象元数据
func (s *SeaweedFSS3) Head(key string) (*models.S3ObjectInfo, error) {
...
func (s *SeaweedFSS3) Get(key string, opts *models.S3GetOptions) (io.ReadCloser, *models.S3ObjectInfo, error) {
...
func (s *SeaweedFSS3) Put(key string, reader io.Reader, size int64, opts *models.S3PutOptions) error {
...
func (s *SeaweedFSS3) List(opts *models.S3ListOptions) (*models.S3ListResult, error) {
...
func (s *SeaweedFSS3) Delete(opts *models.S3DeleteOptions) (int, error) {
...
func (s *SeaweedFSS3) Copy(srcKey, dstKey string) error {
...
func (s *SeaweedFSS3) GetPresignedURL(key string, expires time.Duration) (string, error) {
...
func (s *SeaweedFSS3) PutPresignedURL(key string, expires time.Duration) (string, error) {
