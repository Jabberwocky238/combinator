...
### Spec injection - Inject Specialized Knowledge

**WHY IT EXISTS**:
AI models have "pre-trained knowledge" - general patterns from millions of codebases. But YOUR project has specific conventions that differ from generic patterns.

**WHAT IT ACTUALLY DOES**:
1. Reads `.trellis/spec/` guidelines
2. Loads project-specific patterns into AI's working context

**WHY THIS MATTERS**:
- Without injecting specs: AI writes generic code that doesn't match project style.
- With specs injected: AI writes code that looks like the rest of the codebase.

---

### Quality checks - Combat Context Drift
...
**WHY THIS MATTERS**:
- Without re-checking: Context drift goes unnoticed, code quality degrades.
- With re-checking: Drift is caught and corrected before commit.
...
**[3/8] Read project specs** - Inject project-specific knowledge
**[4/8] Investigate and fix the bug** - Actual development work
**[5/8] /trellis:check-cross-layer** - Re-verify code against guidelines
...
**[2/6] Read project specs** - Re-inject guidelines before fixes
**[3/6] Fix each CR issue** - Address feedback with guidelines in context
**[4/6] /trellis:check-cross-layer** - Verify fixes didn't introduce new issues
...
**[2/6] Read project specs** - Guidelines might document known gotchas
**[3/6] Investigation** - Actual debugging work
**[4/6] /trellis:check-cross-layer** - Verify debug changes don't break other things
...
2. **Guidelines before code** - Spec injection gives AI project knowledge.
3. **Check after code** - Re-checking catches context drift.
...
grep -l "To be filled by the team" .trellis/spec/guides/*.md 2>/dev/null | wc -l
```
...
For example, for `.trellis/spec/guides/cross-layer-thinking-guide.md`:
- What patterns does your project use?
...
Work through the files in `.trellis/spec/guides/`:
