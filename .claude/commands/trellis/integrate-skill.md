...
>
> - Guidelines content -> Write to `.trellis/spec/guides/doc.md`
> - Code examples -> Place in `.trellis/spec/guides/examples/skills/<skill-name>/`
...
|----------------|-------------------|
| UI/Frontend (`frontend-design`, `web-artifacts-builder`) | `.trellis/spec/guides/` |
| Backend/API (`mcp-builder`) | `.trellis/spec/guides/` |
| Documentation (`doc-coauthoring`, `docx`, `pdf`) | `.trellis/` or create dedicated guidelines |
| Testing (`webapp-testing`) | `.trellis/spec/guides/` |
...
- **Integration target**: `.trellis/spec/guides/`
...
| Type | Path |
|------|------|
| Guidelines doc | `.trellis/spec/guides/doc.md` (section: `skill-<name>`) |
| Code examples | `.trellis/spec/guides/examples/skills/<name>/` |
| Index update | `.trellis/spec/guides/index.md` |
...
|-------|-------------------|-------------------|
| `frontend-design` | `guides` | `examples/skills/frontend-design/` |
| `mcp-builder` | `guides` | `examples/skills/mcp-builder/` |
| `webapp-testing` | `guides` | `examples/skills/webapp-testing/` |
